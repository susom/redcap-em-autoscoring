...
$conv = array(1=>-50, 2=>-25, 3=>0, 4=>25, 5=>50);

$normalizedSource = array();
foreach($required_fields as $i=>$field_name) {
	$normalizedSource[$field_name] = $conv[$src[$field_name]];
}

# Calculate our Totals
$result_values = array(
	"total"=>array_sum($normalizedSource)/4
);
